      ...
      <div className="flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="flex items-center justify-between text-sm">
            <button onClick={handleResend} className="text-brand-600 font-medium">
              Resend code
            </button>
            <button
              onClick={() => {
          ...
          <div className="border-t border-slate-100 mt-6 pt-4">
            <p className="text-xs text-slate-500">
              Lost access to your device? <span className="text-brand-600 cursor-pointer">Contact support</span> to re-register.
            </p>
          </div>
        </div>
      </div>
