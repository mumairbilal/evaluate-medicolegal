...
export default function GlobalSearch() {
  ...
  const { role } = useRole()
  const { cases, bookings, clients, doctors, appointments, reports, documents } = usePrototypeData()
    ...
    <section className="bg-white border border-slate-200 rounded-xl p-4 sm:p-5">
      <div className="flex flex-col lg:flex-row lg:items-end gap-3">
        <div className="flex-1">
          <label className="block text-xs font-semibold text-slate-500 mb-1.5">Search query</label>
