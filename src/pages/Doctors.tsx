...
export default function Doctors() {
  const { cases, doctors, appointments, reports, addDoctor } = usePrototypeData()
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-slate-50 text-left text-[11px] text-slate-500 uppercase tracking-wide">
                ...
                <th className="px-4 py-2.5 font-medium">Upcoming appointments</th>
                <th className="px-4 py-2.5 font-medium">Reports in progress</th>
