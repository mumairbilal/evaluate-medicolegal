    ...
    <div className="border-t border-slate-200 pt-3">
      ...
      {status !== 'Not Started' && status !== 'Processing' && status !== 'Failed' && (
        <div className="space-y-2">
          <div className="rounded-lg border border-blue-100 bg-blue-50 px-2.5 py-2 text-[11px] text-blue-700">AI-generated draft — human review required. AI does not make final medical or legal decisions and does not replace doctor approval or Quality Assurance.</div>
